...
public class PlanPostPagoMinutosMegas extends Plan {
    ...
    public PlanPostPagoMinutosMegas(int minutosN, double costoMinutosN, double megasAGigas, double costoPorGiga) {
    ...
    public double calcularCostoPlan() {
        return minutosN * costoMinutosN + megasAGigas/1000 * costoPorGiga;
    }

    @Override
    public String toString() {
        return "\n------Costo de Plan Post Pago Mimutos Megas------"
